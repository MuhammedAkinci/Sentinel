...
import { ArrowUpRight, Play, Eye, Scale, Route, Zap } from "lucide-react";
  ...
  return (
    <div className="flex max-w-5xl flex-col items-center text-center">
      ...
      <motion.div
        ...
        className="mt-16 flex items-center gap-3 font-mono text-[11px] uppercase tracking-[0.32em] text-muted-foreground"
      >
        <span>Press</span>
    ...
    <div className="flex w-full max-w-6xl flex-col">
      ...
      <div className="mt-14 grid grid-cols-1 gap-4 md:grid-cols-4">
        {AGENTS.map((agent, i) => (
          ...
          >
            <div className="absolute -top-3 left-5 bg-background px-2 font-mono text-[10px] uppercase tracking-[0.24em]" style={{ color: agent.accent }}>
...
function Arrow() {
  return <span aria-hidden="true" className="text-foreground/40">→</span>;
}
      ...
      >
        <div className="relative w-full overflow-hidden border border-border bg-background/80">
          <div
            ...
            style={{
              background:
                "radial-gradient(60% 60% at 50% 50%, rgba(0, 255, 136, 0.10), transparent 70%)",
            }}
          >
            {/* Replace this block with a <video> or <iframe> when the
                demo capture is ready. The placeholder stays brand-
                coherent so an empty deck still reads as intentional. */}
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
              <div className="flex h-16 w-16 items-center justify-center rounded-full border border-primary/60 bg-background/80">
                <Play size={28} className="ml-1 text-primary" aria-hidden="true" />
              </div>
              <p className="font-mono text-[11px] uppercase tracking-[0.32em] text-muted-foreground">
                Live capture coming here
              </p>
            </div>
            <div
              aria-hidden="true"
